            ...
            {/* Search Filter From Hero Component */}
            {
                isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                    ...
                    <div className='mb-4 text-gray-600'>
                        {
                            searchFilter.title &&(
                                <span className='inline-flex items-center gap2.5 bg-blue-50 border border-blue-200 px-4 py-1.5 rounded'>
                                    {searchFilter.title}
                        ...
                        }
                        {
                            searchFilter.location &&(
                                <span className='ml-2 inline-flex items-center gap2.5 bg-red-50 border border-red-200 px-4 py-1.5 rounded'>
                                    {searchFilter.location}
                ...
                <ul className='space-y-4 text-gray-600'>
                    {
                        JobCategories.map((category, index) => (
                            <li className='flex gap-3 items-center' key={index}>
                                <input className='scale-125 accent-blue-600' type="checkbox"
